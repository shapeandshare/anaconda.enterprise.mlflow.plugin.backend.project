...
def train(training_data, max_runs, epochs, metric, algo, seed):
    ...
    def new_eval(nepochs, experiment_id, null_train_loss, null_valid_loss, null_test_loss, return_all=False):
        """
    ...
    with mlflow.start_run() as run:
        ...
        train_null_loss, valid_null_loss, test_null_loss = new_eval(0, experiment_id, _inf, _inf, _inf, True)(
            params=[0, 0]
        )
        best = fmin(
